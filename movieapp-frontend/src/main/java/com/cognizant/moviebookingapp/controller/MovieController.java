...
public class MovieController {
	...
	public String getName() throws AuthorizationException {
...
//		stringProducer.sendMessage("getting movies from movie microservies");
	...
	public ResponseEntity<?> bookMovie(@PathVariable(value = "movieName") String movieName,
			@RequestBody Ticket ticket) {
		return ticketService.bookMovie(movieName, ticket);

	}

	@GetMapping("/getUserTickets/{userName}") 
